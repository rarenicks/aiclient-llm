...
from .data_types import BaseMessage, ModelResponse, ToolCall, ToolMessage
...
class Middleware(Protocol):
    ...
    def on_tool_call(self, tool_call: ToolCall) -> ToolCall:
        """
        Intercept and modify a tool call generated by the model.
        Returns the modified tool call.
        """
        return tool_call

    def on_tool_result(self, tool_result: ToolMessage) -> ToolMessage:
        """
        Intercept and modify a tool result provided by the user.
        Returns the modified tool result.
        """
        return tool_result
